...
It's also available a [`deployment-ssl.yaml`](./deployment-ssl.yaml) file which deploys the same producer and consumer applications but using a TLS connection to the cluster.
