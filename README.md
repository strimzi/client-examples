[![Build Status](https://github.com/strimzi/client-examples/actions/workflows/build.yml/badge.svg?branch=main)](https://github.com/strimzi/client-examples/actions/workflows/build.yml?query=branch%3Amain)
